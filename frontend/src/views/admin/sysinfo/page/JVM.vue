...
export default {
  ...
  methods: {
    create () {
      ...
      Promise.all([
        axios({url: 'actuator/metrics/jvm.memory.max'}),
        axios({url: 'actuator/metrics/jvm.memory.committed'}),
        axios({url: 'actuator/metrics/jvm.memory.used'}),
        axios({url: 'actuator/metrics/jvm.buffer.memory.used'}),
        axios({url: 'actuator/metrics/jvm.buffer.count'}),
        axios({url: 'actuator/metrics/jvm.threads.daemon'}),
        axios({url: 'actuator/metrics/jvm.threads.live'}),
        axios({url: 'actuator/metrics/jvm.threads.peak'}),
        axios({url: 'actuator/metrics/jvm.classes.loaded'}),
        axios({url: 'actuator/metrics/jvm.classes.unloaded'}),
        axios({url: 'actuator/metrics/jvm.gc.memory.allocated'}),
        axios({url: 'actuator/metrics/jvm.gc.memory.promoted'}),
        axios({url: 'actuator/metrics/jvm.gc.max.data.size'}),
        axios({url: 'actuator/metrics/jvm.gc.live.data.size'}),
        axios({url: 'actuator/metrics/jvm.gc.pause'})
      ]).then((r) => {
