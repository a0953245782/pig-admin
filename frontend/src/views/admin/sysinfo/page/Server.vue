...
export default {
  ...
  methods: {
    create () {
      ...
      Promise.all([
        axios({url: 'actuator/metrics/system.cpu.count'}),
        axios({url: 'actuator/metrics/system.cpu.usage'}),
        axios({url: 'actuator/metrics/process.uptime'}),
        axios({url: 'actuator/metrics/process.start.time'}),
        axios({url: 'actuator/metrics/process.cpu.usage'})
      ]).then((r) => {
