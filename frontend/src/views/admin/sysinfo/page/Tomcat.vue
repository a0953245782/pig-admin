...
export default {
  ...
  methods: {
    create () {
      ...
      Promise.all([
        axios({url: 'actuator/metrics/tomcat.sessions.created'}),
        axios({url: 'actuator/metrics/tomcat.sessions.expired'}),
        axios({url: 'actuator/metrics/tomcat.sessions.active.current'}),
        axios({url: 'actuator/metrics/tomcat.sessions.active.max'}),
        axios({url: 'actuator/metrics/tomcat.sessions.rejected'}),
        axios({url: 'actuator/metrics/tomcat.global.sent'}),
        axios({url: 'actuator/metrics/tomcat.global.request.max'}),
        axios({url: 'actuator/metrics/tomcat.global.request'}),
        axios({url: 'actuator/metrics/tomcat.servlet.request'}),
        axios({url: 'actuator/metrics/tomcat.servlet.request.max'}),
        axios({url: 'actuator/metrics/tomcat.threads.current'}),
        axios({url: 'actuator/metrics/tomcat.threads.config.max'})
      ]).then((r) => {
